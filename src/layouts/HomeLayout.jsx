...
function HomeLayout({ children }){
    ...
    return (
        ...
        <div className="min-h-[90vh] bg-[#0d1b3b]">
                        ...
                        {!isLoggedIn ? (
                            <li className="absolute bottom-4 w-[90%]">
                                <div className="w-full flex items-center justify-center">
                                    <button className="bg-[#0d1b3b] text-white px-5 py-3 rounded-md font-semibold w-full">
                                    <Link to={`/login`}>Login</Link>
                                    </button>
                                    <button className="bg-yellow-600 px-5 py-3 rounded-md font-semibold w-full">
