...
function Aboutus(){
    return (
        <HomeLayout>
            <div className="flex flex-col items-center justify-center py-20 px-20 gap-10 bg-[#0d1b3b]">
                <div className="space-y-10 flex items-center justify-center gap-20">
                    <div className="w-1/2 flex flex-col gap-10 justify-center">
                        <h1 className="text-5xl text-yellow-500 font-bold">Affordable and Quality Education</h1>
                        <p className="text-3xl text-gray-200 w-[92%] scale">We believe in the transformative power of education. Our team is dedicated to revolutionizing the learning experience by providing a cutting-edge platform that fosters knowledge sharing, skill development, and personal growth. With a passion for innovation and a commitment to excellence.</p>
                    </div>
                ...
                <div className="carousel w-full my-10 mx-auto">
                    <div id="slide1" className="carousel-item relative w-full ">
                        ...
                        <h3 className="text-2xl text-yellow-500 font-semibold">APJ Abdul Kalam</h3>
                    ...
                    <div id="slide2" className="carousel-item relative w-full">
                        ...
                        <h3 className="text-2xl text-yellow-500 font-semibold">Bill Gates</h3>
                        <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                    ...
                    <div id="slide3" className="carousel-item relative w-full">
                        ...
                        <h3 className="text-2xl text-yellow-500 font-semibold">Nelson Mandela</h3>
                        <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                        <a href="#slide2" className="btn btn-circle">❮</a> 
                        <a href="#slide4" className="btn btn-circle">❯</a>
                        </div>
                    ...
                    <div id="slide4" className="carousel-item relative w-full">
                        ...
                        <h3 className="text-2xl text-yellow-500 font-semibold">Steve Jobs</h3>
                        <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                        <a href="#slide3" className="btn btn-circle">❮</a> 
                        <a href="#slide1" className="btn btn-circle">❯</a>
                        </div>
