...
function CourseCreate(){
        ...
        return (
            <HomeLayout>
            <div className="h-[100vh] flex items-center justify-center bg-[#0d1b3b]">

                <form
                    onSubmit={onFormSubmit}
                    className="flex flex-col justify-center gap-5 rounded-lg p-6 text-white h-[500px] w-[700px] shadow-[0_0_10px_black] relative"
                >   
                    ...
                    <button
                        type="submit"
                        className="w-full py-2 rounded-sm font-semibold text-lg cursor-pointer bg-yellow-600 hover:bg-yellow-500 transition-all ease-in-out duration-300 mt-2"
                    >
                        Create Course
                    </button>
                </form>
